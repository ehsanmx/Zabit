...
class IncomeTypeController extends Controller
{
	...
	public function actionGetList(){
		...
		if(isset($_GET['term']) && $_GET['term']!='all'){
			$types = IncomeType::model()->findAll(array(
					'condition'=>'name like :term',
					'params'=>array(':term'=>'%'.$_GET['term'].'%'),
					));
		}else{
			$types = IncomeType::model()->findAll();				
		}
	...
	public function actionCreate()
	{
		...
		{
			$model->attributes=$_POST['IncomeType'];
	...
	{
		$dataProvider=new CActiveDataProvider('IncomeType');
	...
	public function actionList()
	{
		...
		if(isset($_GET['IncomeType']))
			$model->attributes=$_GET['IncomeType'];
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='income-type-form')
		{
